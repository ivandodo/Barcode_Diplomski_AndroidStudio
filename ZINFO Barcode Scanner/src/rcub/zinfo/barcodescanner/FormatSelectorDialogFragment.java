...
/**
 * Struktura za kreiranje dijaloga za izbor formata bar-kodova koji se prepoznaju.
 */
public class FormatSelectorDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        // Postavljanje naslova dijaloga
        builder.setTitle(R.string.choose_formats)
                // Postavljanje mogucnosti za izbor
                .setMultiChoiceItems(formats, checkedIndices,
                 ...
                 // Postavljanje akcija za potvrdan i odrican odgovor
